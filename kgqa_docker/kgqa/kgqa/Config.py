...
DEFAULT_CONFIG_PATH = "./kgqa/kgqa/config.yaml"
# DEFAULT_CONFIG_PATH = "/Users/shivanishrivastava/Documents/projects/qirk-rai/qirk_docker/kgqa/kgqa/config.yaml" # local
